...
Chart.elements.RoundedTopRectangle = Chart.elements.Rectangle.extend({
  draw: function() {
    ...
    if (!vm.horizontal) {
      // bar
      left = vm.x - vm.width / 10;
      right = vm.x + vm.width / 10;
      top = vm.y;
      bottom = vm.base;
      signX = 1;
    ...
    var roundness = this._chart.config.options.barRoundness || 2;
    var radius = barWidth * roundness * 2;

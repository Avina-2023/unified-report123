...
const routes: Routes = [
  {
    path: `${APP_CONSTANTS.ROUTES.DRIVE.MANAGEDRIVE}`,
    component: ManageDriveComponent,
  },
  {
    path: `${APP_CONSTANTS.ROUTES.DRIVE.DRIVESETTINGS}`,
    component: DriveSettingsComponent,
  },
  {
    path: `${APP_CONSTANTS.ROUTES.DRIVE.VIEWCANDIDATE}`,
    component: ViewCandidateByDriveComponent,
  },
  {
    path: `${APP_CONSTANTS.ROUTES.DRIVE.VIEWCANDIDATEPROFILEBYEMPLOYER}`,
    component: ViewCandidateProfilebyEmployerComponent,
  },
];

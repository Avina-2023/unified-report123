          ...
          for (let i = 0; i < nodeArray.length; i++) {
            if (nodeArray[i].nodeName === "BUTTON") {
              if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
                ...
                this.ren.setStyle(nodeArray[i], "color", "#8898AA80");
                this.ren.setStyle(nodeArray[i], "border", "solid 1px #8898AA80");
                ...
                this.ren.setStyle(nodeArray[i], "border", "solid 1px #8898AA80");
                this.ren.setStyle(nodeArray[i], "color", "#1B4E9B");
                this.ren.setStyle(nodeArray[i], "margin", ".5%");
              } else if (nodeArray[i].disabled) {
                this.ren.setStyle(nodeArray[i], "background-color", "#1B4E9B");

...
//             'profileImage',
//             this.profileImage + environment.blobToken
//           );
...
//         console.log(this.profilepercentage,'profilepercentage profilepercentage')
//         this.appConfig.setLocalStorage(
//           'profilePercentage',
...
public conetnt:any;
  ...
  recentjobs:any = [
    {
      "imgurl" : "../../../../assets/images/amadis-logo.png",
      "title": "Amadis Technologies",
      "specialization": "IT/Computers"
    },
    {
      "imgurl" : "../../../../assets/images/LNT C.png",
      "title": "L&T Construction",
      "specialization": "Construction"
    },
    {
      "imgurl" : "../../../../assets/images/omega-HC.png",
      "title": "Omega Healthcare",
      "specialization": "Medical"
    },
    {
      "imgurl" : "../../../../assets/images/LTI-MT.png",
      "title": "LTI Mindtree",
      "specialization": "IT"
    },
    {
      "imgurl" : "../../../../assets/images/bank-zone2.png",
      "title": "Bankzone",
  ...
  CandidateDetails() {
    ...
    this.apiService.candidateDetails(obj).subscribe((res: any) => {
      if (res.success) {
        ...
        this.gender = this.Details.personal_details?.gender;
        // this.memberjoindate = this.Details.account_Activated_at
        this.memberjoindate = this.Details.createdAt;
        this.timestamp = new Date(this.memberjoindate);

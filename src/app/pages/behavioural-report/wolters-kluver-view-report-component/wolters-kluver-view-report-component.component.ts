...
@Component({
  selector: 'app-wolters-kluver-view-report-component',
  templateUrl: './wolters-kluver-view-report-component.component.html',
  styleUrls: ['./wolters-kluver-view-report-component.component.scss']
})
export class WoltersKluverViewReportComponentComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  downloadreport(val) {
    if (val) {
      ...
      this.sendData.sendMessage(true, 'wolter-kluver');
    } else {
